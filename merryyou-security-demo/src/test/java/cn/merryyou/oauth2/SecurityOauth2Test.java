...
import cn.merryyou.utils.JsonUtil;
...
public class SecurityOauth2Test {
    //端口
    final static long PORT = 8060;
    //clientId
    final static String CLIENT_ID = "merryyou";
    //clientSecret
    final static String CLIENT_SECRET = "merryyousecret";
    //用户名
    ...
    //获取用户信息得URL
    final static String USER_INFO_URI = "http://127.0.0.1:" + PORT + "/user/me";
